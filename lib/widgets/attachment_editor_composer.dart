...
void _launchURL(url) async =>
    await canLaunch(url) ? await launch(url) : throw 'Çalışamadı.. $url';
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: IconButton(
                                  ...
                                  onPressed: () async {
                                    String safeURL = widget
                                        .attachmentList[index].url
                                        .replaceAll(
                                            new RegExp(r'[^\w\s]+'), '');
                                    ...
                                    if (widget.title != "" &&
                                        widget.isTeacher) {
                                      await AttachmentsDB()
                                          .deleteAttachAnnounceDB(
                                              widget.title, safeURL);
                                      print(
                                          "Duyurudaki eke yapılan referans silindi...");
                                    } else {
                                      await AttachmentsDB()
